...
class Task(models.Model):
    ...
    description = models.TextField(max_length=4000, blank=True, verbose_name="Descrição")
    solution = models.TextField(max_length=4000, null=True, blank=True, verbose_name="Solução")
